  ...
  function (_React$Component) {
    ...
    function TextChatContainer() {
      ...
      defineProperty(assertThisInitialized(_this), "initWebSocket", function () {
        _this.io = lib$1("ws://localhost:3000");
    ...
    createClass(TextChatContainer, [{
      ...
      value: function render() {
        var _this$state = this.state,
            ...
            username = _this$state.username;
        return React.createElement("div", null, React.createElement("div", null, "Connection state: ", connected ? React.createElement("div", {
          style: {
            color: "green"
          }
