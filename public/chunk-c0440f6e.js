...
function fmtLong$2(ms) {
  return plural$2(ms, d$3, 'day') ||
    ...
    plural$2(ms, m$3, 'minute') ||
    plural$2(ms, s$3, 'second') ||
    ms + ' ms';
}
...
var MessageSorter = function MessageSorter(_ref) {
  ...
  var messagesSorted = messages.sort(function (a, b$$1) {
    return a.datetime - b$$1.datetime;
  });
  return children({
...
export { ChatRoom as a, E as b, h as c };
